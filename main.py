...
# Train the model
# model, training_losses, training_accuracies, val_losses, val_accuracies = \
# train_model(train_loader, test_loader, device, lr, in_channels, out_channels, num_epochs)
